...
\outcome{Explore how different orientation of cross sections changes the setup of an integral or sum of integrals}

\begin{document}
\begin{exercise}


The base of a solid is the region in the first quadrant by $y=8-x^2$ and the $y=2x$. This exercise explores the effect of changing the orientation of the cross-sections. 
